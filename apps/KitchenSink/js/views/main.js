    ...
    App.MainView = joint.mvc.View.extend({
        ...
        initializePaper: function() {
            ...
            graph.on('add', function(cell, collection, opt) {
                console.log('DEBUG', '57 Element Added to GRAPH ', {cell, collection, opt});
        ...
        initializeKeyboardShortcuts: function() {
            ...
            this.keyboard.on({
                ...
                'a': function () {
                    // Save Data
                    window.localStorage.setItem('graphData', JSON.stringify(this.graph.toJSON()));
                },
                'q': function () {
                    // Populate Data
                    this.graph.fromJSON(JSON.parse(window.localStorage.getItem('graphData')));
                },
        ...
        initializeToolsAndInspector: function() {
            ...
            this.graph.on('change', function(cell, opt) {
                console.log('DEBUG', '333 ELEMENT POSITION CHANGED ON GRAPH ', {cell, opt });
